	...
	<body>
		...
		<div id="carousel" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active" style="background-image: url('img/montagna.jpg');">
		...
		<!-- Primo box: testo (left) e immagine (right) -->
		<div class="container" style="margin-top: 40px;">
			<div class="row">
				<div class="col-md-6">
					<h3 class="text-center title-green" style="margin-top: 22px;">BIOPARCO FATTORIA ROSABELLA</h3>
					<h5 class="text-center">Un'avventura straordinaria</h5>
					<p>
						La più grande avventura che tu possa mai vivere.<br>
						Vieni a trovarci, ci troviamo a solo 40km dalla città di Salerno e 50km dalla città di Avellino, nel cuore della Campania. Il <strong>bioparco Fattoria Rosabella</strong> ti aspetta, con tante attività da svolgere!
		...
		<div class="container" style="margin-top: 40px;">
			<div class="row">
				<div class="col-md-6">
					<img src="img/Fattoria didattica.jpg" class="img-thumbnail" alt="">
				</div>
				
				<div class="col-md-6">
					<h3 class="text-center title-green" style="margin-top: 22px;">LA FATTORIA DIDATTICA</h3>
					<h5 class="text-center">Per i più piccoli</h5>
					<p>
						La più grande avventura che tu possa mai vivere.<br>
						Vieni a trovarci, ci troviamo a solo 40km dalla città di Salerno e 50km dalla città di Avellino, nel cuore della Campania. Il <strong>bioparco Fattoria Rosabella</strong> ti aspetta, con tante attività da svolgere!
						Tra le attività proposte abbiamo escursione, visite guidate, pic-nic, bagno alla cascata della Maronnella e, per i più piccoli, la fattoria didattica. Naviga il nostro sito per saperne di più. Inoltre, è possibile prenotare le attività citate amche attraverso il sito!<br>
