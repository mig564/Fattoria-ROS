...
<body>
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="container-fluid cover-img" style="background-image: url('img/cascata.jpg');">
			<div class="container">
				<div class="text-center cover-text">
					<h3 class="title-green">CONTATTI</h3>
					<p style="color: white;">Scrivici o chiamaci per avere informazioni</p>
				</div>
			</div>
		</div>
