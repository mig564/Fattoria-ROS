		...
		<div class="container card">
			...
			<%if(carte != null && carte.size() > 0) {
				...
				<div class="col-sm-3 mx-auto">
					<p class="text-center"><button type="button" class="btn btn-link" style="color:red; text-decoration: none;" onclick="CarteControl?action=elimina&numero=<%=bean.getNumero() %>">
