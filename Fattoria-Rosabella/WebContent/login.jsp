			...
			<div class="row">	
				<div class="col-md-6 card " style = "height: 100%; padding: 20px;">
					...
					<form name="login" method="post" action="Login">
						...
						<p>Non sei registrato? <a href="#" onclick="javascript:showFormRegister()">Clicca qui!</a></p>
					</form>
					...
					<form name="registrazione" method="post" action="Registration" onSubmit="javascript:return check_reg()" style="display: none;">
						...
						<p>Sei già registrato? <a href="#" onclick="javascript:showFormLogin()">Clicca qui!</a></p>
					</form>
				</div>
				
				<div class="col-md-6">
					<img alt="login" src="illustrations/login.svg" width="80%">
				</div>
