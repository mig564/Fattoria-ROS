<%@page import="beans.PrenotazioneAttivita"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
		pageEncoding="ISO-8859-1"  import="java.util.*" import="beans.*" import="model.*"%>
<%
PrenotazioneAttivitaModelDM attivitaModelDM = new PrenotazioneAttivitaModelDM();
AttivitaModelDM attivitaDM = new AttivitaModelDM();
Collection<?> prenotazioni = (Collection<?>) request.getAttribute("prenotazioni"); 
if (prenotazioni == null) {
	response.sendRedirect(response.encodeRedirectURL("./PrenotazioneControl"));
	return; 
}
			...
			<%
				...
				while(iterator.hasNext()){
					...
					<div class="row" style="margin-top: 20px;">  
						...
						<div class="col-md-2"><p class="text-center"><%=bean.getPrezzo()%>,00 Euro</div>
						<div class="col-md-2"><p class="text-center">
  							<button class="btn btn-outline-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<%=bean.getId_prenotazione() %>" aria-expanded="false" aria-controls="collapseExample">
						...
						<div class="collapse" id="collapse<%=bean.getId_prenotazione() %>">
