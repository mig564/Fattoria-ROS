...
<nav class="navbar navbar-expand-lg navbar-light">
		...
		<!-- area personale -->
		<div id="titolo">
			<h2 style="color:#198754;text-align: center;">Il mio profilo</h2>
		</div>
		<!-- recuperiamo i dati relativi al cliente  -->
		
	<%Utente utente = (Utente) request.getAttribute("utente"); 
    if(utente == null){
    	response.sendRedirect(response.encodeRedirectURL("./AreaPersonale?action=area"));
    	return;
    }%>
    	...
    	<div class="container" style="margin-top: 40px;">
    		<div class="row">
    			<form name="registrazione" method="post" action="AreaPersonale" onSubmit="">
						...
						<div class="form-floating" style="margin-bottom: 22px;">
							<input type="text" class="form-control" value="<%=utente.getCognome() %>" name="cognome" id="cognomeUtente"  placeholder="Cognome">
							<label for="cognomeUtente">Cognome</label>
						</div>
						<div class="form-floating" style="margin-bottom: 22px;">
							<input type="date" class="form-control" value="<%=utente.getData_nascita() %>" name="data_nascita" id="dataDiNascita"  placeholder="DataDiNascita">
							<label for="dataDiNascita">Data di nascita</label>
						</div>
						<div class="form-floating" style="margin-bottom: 22px;">
							<input type="text" class="form-control" value="<%=utente.getIndirizzo() %>" name="indirizzo" id="indirizzoUtente"  placeholder="Indirizzo">
