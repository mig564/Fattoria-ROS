...
public class CarrelloAjax extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		formCart.add(new Formare((int)request.getSession().getAttribute("carrello"), Integer.parseInt(id), (String)request.getAttribute("data"), (String)request.getParameter("ora"), Integer.parseInt(partecipanti)));
